              ...
              child: ConstrainedBox(
                  ...
                  child: Column(children: [
                    ...
                    DropdownButton<Rotation90>(
                      items: const [
                        DropdownMenuItem(value: Rotation90.text, child: Text('0 counterclockwise')),
                        DropdownMenuItem(value: Rotation90.text90, child: Text('90 counterclockwise')),
                        DropdownMenuItem(value: Rotation90.text180, child: Text('180 counterclockwise')),
                        DropdownMenuItem(value: Rotation90.text270, child: Text('270 counterclockwise')),
                      ],
                      onChanged: (item) {
                        rotation = item!;
                        setState(() {});
                    ...
                    ElevatedButton(onPressed: () => _onPressed(context), child: const Text("Add QR Code")),
                    ElevatedButton(
                        onPressed: () {
